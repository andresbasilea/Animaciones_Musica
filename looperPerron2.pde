...
void setup() {
  ...
  //reverb4 = new Reverb(this);
  //reverb5 = new Reverb(this);
  ...
  track1 = new SoundFile(this, "silencio.mp3");
  onda1 = new processing.sound.Waveform(this, samples);
  onda1.input(track1);
  //reverb1.process(track1);
  duracionTrack1 = track1.duration();
  print(duracionTrack1);
  print("hola track1 ");
  track2 = new SoundFile(this, "silencio.mp3");
  onda2 = new processing.sound.Waveform(this, samples);
  onda2.input(track2);
  //reverb2.process(track2);
  print("hola track2 ");
  track3 = new SoundFile(this, "silencio.mp3");
  onda3 = new processing.sound.Waveform(this, samples);
  onda3.input(track3);
  //reverb3.process(track3);
  print("hola track3 ");
  track4 = new SoundFile(this, "silencio.mp3");
  onda4 = new processing.sound.Waveform(this, samples);
  onda4.input(track4);
  //reverb4.process(track4);
  print("hola track4 ");
  track5 = new SoundFile(this, "silencio.mp3");
  onda5 = new processing.sound.Waveform(this, samples);
  onda5.input(track5);
  //reverb5.process(track5);
  print("hola track5 ");
...
public void PlayPausaTotal() {
  ...
  if (track1.isPlaying()==false && track2.isPlaying()==false && track3.isPlaying()==false && track4.isPlaying()==false && track5.isPlaying()==false && Matriz.isPlaying()==false) {
    track1.play();
    track2.play();
    track3.play();
    track4.play();
...
public void Grabar2() {
  ...
  borrar.delete();
  recorder.beginRecord();
  long inicio = System.currentTimeMillis(); // esperar y hacer grabacion 2 de la misma duracion que grabacion 1
  print(duracionTrack1);
  while(duracionTrack1*1000 >= System.currentTimeMillis()-inicio){
  }
  //delay(1000);
  recorder.endRecord();
  recorder.save();
  ...
  float duracionTrack2 = track2.duration();
  print(duracionTrack2);
  onda2 = new processing.sound.Waveform(this, samples);
  onda2.input(track2);
  //reverb2.process(track2);
  R = temp[0];
...
public void Grabar3() {
  ...
  borrar.delete();
  recorder.beginRecord();
  long inicio = System.currentTimeMillis(); // esperar y hacer grabacion 3 de la misma duracion que grabacion 1
  print(duracionTrack1);
  while(duracionTrack1*1000 >= System.currentTimeMillis()-inicio){
  }
  recorder.endRecord();
...
public void Grabar4() {
  ...
  borrar.delete();
  recorder.beginRecord();
  long inicio = System.currentTimeMillis(); // esperar y hacer grabacion 4 de la misma duracion que grabacion 1
  print(duracionTrack1);
  while(duracionTrack1*1000 >= System.currentTimeMillis()-inicio){
  }
  recorder.endRecord();
...
public void Grabar5() {
  ...
  borrar.delete();
  recorder.beginRecord();
  long inicio = System.currentTimeMillis(); // esperar y hacer grabacion 5 de la misma duracion que grabacion 1
  print(duracionTrack1);
  while(duracionTrack1*1000 >= System.currentTimeMillis()-inicio){
  }
  recorder.endRecord();
